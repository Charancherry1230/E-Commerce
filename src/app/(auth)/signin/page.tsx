        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:block relative w-1/2">
                ...
                <div className="absolute bottom-12 left-10 text-white">
                    <p className="text-amber-400 uppercase tracking-[0.3em] text-xs font-bold mb-3">Welcome Back</p>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-16 bg-white">
                <div className="w-full max-w-md">
                    ...
                    <p className="text-slate-500 text-sm mb-10">
                        ...
                        <Link href="/signup" className="text-amber-500 font-semibold hover:underline underline-offset-4">
                            Create one
                        </Link>
                    </p>
